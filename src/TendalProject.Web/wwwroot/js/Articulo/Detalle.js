function confirmarCambioEstado(estadoActual) {
    ...
    Swal.fire({
        title: activando
            ? "¿Quieres activar este artículo?"
            : "¿Quieres desactivar este artículo?",

        text: activando
            ? "El artículo volverá a estar disponible para la venta."
            : "El artículo quedará inactivo y no se podrá vender.",
